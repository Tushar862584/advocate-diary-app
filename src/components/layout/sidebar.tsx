    ...
    <>
      ...
      >
        <div className="p-4 border-b border-slate-700 flex items-center justify-between">
          {!collapsed && <h1 className="text-xl font-bold text-blue-400">Advocate Diary</h1>}
        ...
        <div className={`p-2 border-t border-slate-700 ${collapsed ? 'flex flex-col items-center' : ''}`}>
          {!collapsed && (
            <div className="flex items-center mb-3 p-2 rounded-md bg-slate-700/50">
              <UserCircle size={22} className="text-blue-400 mr-3 flex-shrink-0" />
      ...
      {/* Mobile menu drawer */}
      <div className={`md:hidden fixed inset-y-0 left-0 z-30 w-64 bg-slate-800 shadow-lg transition-transform duration-300 transform ${
